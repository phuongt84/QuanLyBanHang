		...
		<div class="row">
			<div class="col-md-12">
				<div class="">
					...
					<!-- MyUploadForm -->
					<form:form modelAttribute="suaLoaiHangInfo" method="POST"
						action="${pageContext.request.contextPath}/admin/loaihang/sualoaihang/hoanthanh/${loaiID.maLoai }"
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									...
									<form:input path="tenLoai" value="${loaiID.tenLoai }" type="text" class="form-control"
										 id="tenLoai" />
